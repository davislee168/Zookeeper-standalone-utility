...
?
zkdlock::zkdlock(const string &hostname, const string &lockpath, const string &name, bool 
watchPrecedingNode)
{
m_zkhosts = hostname;
...
?
void zkdlock::construct_zkclient(const string &connectingstring, long sessionTimeout, long 
connectionTimeout)
{
